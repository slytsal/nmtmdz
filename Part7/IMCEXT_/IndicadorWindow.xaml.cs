...
namespace IMC.Wpf.CoverFlow.NMT
{
    ...
    public partial class IndicadorWindow : Window
    {
        ...
        {
            Util.Instance.playSound("C:/_covers/Media/Sounds/click.wav");
        ...
        public void initfilters()
        {
            ...
            List<Filtro> filtros = chart.obtenerFiltros(reporte);
       ...
       /// <param name="LAST_FILTER"></param>
        ...
        private void imageHome_MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
            ...
            parent.Show();
            ((PrincipalWindow)parent).reinitLastInfo(this.flow.Index, lastfiltros);
        }
        ...
        {
            Util.Instance.playSound("C:/_covers/Media/Sounds/snap.wav");
        ...
        {
            Util.Instance.playSound("C:/_covers/Media/Sounds/over.wav");
        }
        ...
        {
            Util.Instance.playSound("C:/_covers/Media/Sounds/click.wav");
            ColorsGlassWindow col = new ColorsGlassWindow(this);
            col.ShowDialog();
        }
        ...
        {
            Util.Instance.playSound("C:/_covers/Media/Sounds/over.wav");//C:/_covers/over.wav");
        }
