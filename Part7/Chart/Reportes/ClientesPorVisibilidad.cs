...
{
    class ClientesPorVisibilidad : IMC.Wpf.CoverFlow.NMT.ChartComponent.IChart
    {
        ...
        public List<Filtro> ObtenerFiltros()
        {
            ...
            DataTable filtro1 = consulta.SelectKPI_ClientesPorVisibilidad_Flt_Segmentacion().Tables[0];
        ...
        public Chart Draw(params string[] filtros)
        {
            ...
            try
            {
                kpis = new DataTable();
                Consultas consulta = new Consultas();
                kpis = consulta.SelectKPI_ClientesPorVisibilidad(filtros).Tables[0];
                consulta = null;
                string serAnt = "-5555";
                string ser = "-1111";
