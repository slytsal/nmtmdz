...
namespace IMC.Wpf.CoverFlow.NMT.ChartComponent.Reportes
{
    ...
    /// Reporte
    /// </summary>
    class ShareOfSegment : IMC.Wpf.CoverFlow.NMT.ChartComponent.IChart
    {
        ...
        public Chart Draw(params string[] filtros) 
        {
            ...
            try
            {
                kpis = new DataTable();
                Consultas consulta = new Consultas();
                kpis = consulta.SelectKPI_Share_Segment(filtros).Tables[0];
                consulta = null;
                string serAnt = "-5555";
                string ser = "-1111";
