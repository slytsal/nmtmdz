...
{
    public class Clientes : IMC.Wpf.CoverFlow.NMT.ChartComponent.IChart
    {
        ...
        public Chart Draw(params string[] filtros)
        {
            ...
            try
            {
                ...
                if (filtros[0] != "Todos")
                    kpiClientes = consulta.SelectPointsClientesFiltrado(filtros[0]).Tables[0];
                else
                    kpiClientes = consulta.SelectPointsClientes().Tables[0];
                consulta = null;
                ...
                foreach (DataRow g in kpiClientes.Rows)
                {
                    ...
                    dataPointClientes.ToolTipText ="NOMBRE CLIENTE: "+cliente+"\nTOTAL BUDI:"+ valorXreal.ToString() + "\nCPW: " + valorYreal.ToString();
        ...
        public DataTable ObtenerClientes()
        {
            ...
            Consultas consulta = new Consultas();
            DataTable ClientesBudi = consulta.SelectClientesBudi().Tables[0];
            return ClientesBudi;
        }
        public DataTable ObtenerClientesFiltrado(string Filtro)
        {

            Consultas consulta = new Consultas();
            DataTable ClientesBudi = consulta.SelectClientesBudiFiltrado(Filtro).Tables[0];
            return ClientesBudi;
        }  
    }
}
