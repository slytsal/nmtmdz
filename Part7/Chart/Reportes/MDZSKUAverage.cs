...
namespace IMC.Wpf.CoverFlow.NMT.ChartComponent.Reportes
{
    ...
    /// Reporte
    /// </summary>
    class MDZSKUAverage : IMC.Wpf.CoverFlow.NMT.ChartComponent.IChart
    {
        ...
        public List<Filtro> ObtenerFiltros()
        {
            ...
            DataTable filtro1 = consulta.SelectKPI_MDZ_SKU_Average_Flt_IndustryLevel().Tables[0];
        ...
        public Chart Draw(params string[] filtros) 
        {
            ...
            try
            {
                kpis = new DataTable();
                Consultas consulta = new Consultas();
                kpis = consulta.SelectKPI_MDZ_SKU_Average(filtros).Tables[0];
                consulta = null;
                string serAnt = "-5555";
                string ser = "-1111";
