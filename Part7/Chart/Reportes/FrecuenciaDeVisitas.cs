...
namespace IMC.Wpf.CoverFlow.NMT.ChartComponent.Reportes
{
    ...
    /// Reporte
    /// </summary>
    class FrecuenciaDeVisitas : IMC.Wpf.CoverFlow.NMT.ChartComponent.IChart
    {
        ...
        public List<Filtro> ObtenerFiltros()
        {
            ...
            DataTable filtro1 = consulta.SelectKPI_FrecuenciaVisitas_Flt_IndustryLevel().Tables[0];
        ...
        public Chart Draw(params string[] filtros) 
        {
            ...
            // Set title property
            title.Text = "Frecuencia De Visitas";
            ...
            try
            {
                kpis = new DataTable();
                Consultas consulta = new Consultas();
                kpis = consulta.SelectKPI_FrecuenciaVisitas(filtros).Tables[0];
                consulta = null;
                string serAnt = "-5555";
                string ser = "-1111";
                foreach (DataRow g in kpis.Rows)
                {
                    Decimal? y = g["FreqVisits"]!=DBNull.Value? (Decimal?)g["FreqVisits"]:null;
